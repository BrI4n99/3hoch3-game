...
public class ib_fence : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 360; i += 5) {
            ...
            Vector3 grasPos = new Vector3(-1, -0.5f, i -3 );
            GameObject grasNew = Instantiate(gras, grasPos, Quaternion.identity);
            grasNew.transform.Rotate(270, 0, 0, Space.World);
            grasNew.transform.parent = transform;

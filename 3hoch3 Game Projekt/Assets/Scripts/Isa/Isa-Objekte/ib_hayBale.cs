...
public class ib_hayBale : MonoBehaviour
{
    ...
    public void showBales()
    {
        ...
        boxCollider.size = new Vector3(2 * baleWidth +0.5f, baleHeight, 2 * baleLength-0.1f);
    ...
    // Was passiert bei einer Kollision mit dem Character? 
    // Punktabzug
    // zurücksetzen?
    ...
    void OnCollisionEnter(Collision otherObj)
    {
        ...
        //if (otherObj.gameObject.name == "Koerper" || otherObj.gameObject.name == "Kopf" || otherObj.gameObject.name == "beineVorn" || otherObj.gameObject.name == "beineHinten")
        {
            if (touch != true)
            {
                minuspunkte += abzug;
    ...
    // Heuballen sollen sich physikalisch korrekt bewegen
}

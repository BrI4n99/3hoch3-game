...
public class TL_CurveLeftPart : MonoBehaviour
{
    [Header("Materials")]
    ...
    {
        print("sdfdsdf");
        if (collision.gameObject.name == "Part")
        {
            print("loool es geht");
        }
    }
    ...
    void Start()
    {
        ...
        //Wand außen hinten
        vertices[12] = new Vector3(-4.5f, 0, 7);
        vertices[13] = new Vector3(2.5f, 0, 7);
        vertices[14] = new Vector3(-4.5f, 5, 7);
        vertices[15] = new Vector3(2.5f, 5, 7);
        ...
        uvs[17] = new Vector2(0.4f, 0f);
        uvs[18] = new Vector2(0f, 1f);
        uvs[19] = new Vector2(0.4f, 1f);
        //Wand innen hinten
        uvs[20] = new Vector2(0.4f, 0f);
        uvs[21] = new Vector2(1f, 0f);
        uvs[22] = new Vector2(0.4f, 1f);

...
public class kjg_enemySchiessen3 : MonoBehaviour
{
    ...
    void shoot()
    {
        ...
        temptomatoRigidbody.AddForce(-temptomatoRigidbody.transform.forward * bulletSpeed);
    ...
    {
        zeit += Time.deltaTime;
        if (zeit > 1 && kjg_triggerShooting.shootTrigger)
        {
            shoot();
            zeit = 0;
        }
